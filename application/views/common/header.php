                ...
                <div class="col-xs-3 col-md-4">
                  <a href="#" class="angled-img">
                    <div class="img">
                      ...
                      <img src="<?php echo base_url() ?>assets/images/game-bloodborne-500x375.jpg" alt="">
                    </div>
                  </a>
                </div>
                ...
                <div class="col-xs-3 col-md-4">
                  <a href="#" class="angled-img">
                    <div class="img">
                      ...
                      <img src="<?php echo base_url() ?>assets/images/game-kingdoms-of-amalur-reckoning-500x375.jpg" alt="">
                    </div>
                  </a>
                </div>
                <div class="col-xs-9 col-md-8">
